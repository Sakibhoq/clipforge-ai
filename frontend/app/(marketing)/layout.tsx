  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" className="pointer-events-none fixed inset-0 z-[-20] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(1200px_680px_at_50%_0%,rgba(255,255,255,0.03),transparent_66%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(1100px_600px_at_12%_18%,rgba(56,130,246,0.22),transparent_62%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(1100px_600px_at_88%_22%,rgba(129,90,255,0.22),transparent_62%)]" />
