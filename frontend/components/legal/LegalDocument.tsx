...
const PRIVACY_SECTIONS: Section[] = [
  {
    ...
    body: (
      <div className="space-y-2">
        <p>
          This Privacy Policy explains how {BRAND.name} (Orbito, we, us, or our) collects, uses, stores, shares, and
  ...
  },
  {
    ...
    body: (
      <div className="space-y-2">
        <p>
          Orbito uses automated systems for tasks such as speech timing, caption generation, segment scoring, and
          framing suggestions.
        </p>
        <p>
...
export default function LegalDocument({ kind }: { kind: LegalKind }) {
  ...
  const subtitle = isPrivacy
    ...
    : "Rules for using Orbito and related services.";
