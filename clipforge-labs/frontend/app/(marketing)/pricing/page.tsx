        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <div className="text-xs text-white/55">
              Scale Creator credits without changing your base plan.
              Choose 1× to 10×.
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-4">
            ...
            <div className="flex items-center gap-3">
              <input
                aria-label="Creator pack multiplier"
                type="range"
                min={1}
                max={10}
                step={1}
...
async function startCheckout(plan: "free" | "starter" | "creator") {
  ...
  const trialCredits = 75;
  const starterMonthlyCredits = 390;
  const creatorMonthlyCredits = 990;
  ...
  const discountLabel = useMemo(() => "−20%", []);
  ...
  return (
    ...
    <div className="relative">
      ...
      >
        ...
        <div className="absolute -top-40 left-[-20%] hidden h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle_at_center,rgba(255,183,3,0.20),transparent_62%)] blur-3xl sm:block" />
        <div className="absolute top-24 right-[-18%] hidden h-[560px] w-[560px] rounded-full bg-[radial-gradient(circle_at_center,rgba(58,134,255,0.16),transparent_64%)] blur-3xl sm:block" />
        <div className="absolute bottom-[-18%] left-[10%] hidden h-[640px] w-[640px] rounded-full bg-[radial-gradient(circle_at_center,rgba(251,86,7,0.12),transparent_65%)] blur-3xl sm:block" />
      </div>
      ...
      <section className="relative mx-auto max-w-6xl px-4 pb-16 pt-10 sm:px-6">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-4">
          ...
          <div className="group surface creator-highlight relative p-5 sm:p-6 flex flex-col overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.03]">
            <div className="pointer-events-none absolute -inset-10 opacity-70">
              <div className="absolute inset-0 bg-[radial-gradient(520px_280px_at_40%_25%,rgba(255,183,3,0.16),transparent_62%)]" />
              <div className="absolute inset-0 bg-[radial-gradient(520px_280px_at_70%_45%,rgba(58,134,255,0.14),transparent_62%)]" />
            </div>
            ...
            <div className="relative">
              ...
              <div className="mt-4 text-sm text-white/70">
                Built for creators posting daily and iterating fast.
              </div>
            ...
            <div className="relative">
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                ...
                <div className="text-xs text-white/45">
                  Top-up packs only affect Creator credits and pricing.
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mt-14">
          <div className="surface p-5 sm:p-6 md:p-8">
            ...
            <div className="mt-6 grid gap-3 md:grid-cols-2">
              ...
              <FAQItem
                q="What do packs do?"
                a="Top-up packs scale Creator only: both included credits and Creator pricing. Starter stays fixed."
                open={!!faqOpen.packs}
                onToggle={() => toggleFaq("packs")}
              />
              <FAQItem
                q="How does yearly billing work on Creator?"
                a="Yearly Creator delivers the full year's credits upfront (11,880 × pack). Monthly refresh is replaced by upfront delivery."
                open={!!faqOpen.yearly}
                onToggle={() => toggleFaq("yearly")}
              />
              <FAQItem
                q="What do I get on the free trial?"
                a={`${trialCredits} credits to run the workflow end-to-end. Free Trial cannot publish to social until you upgrade.`}
                open={!!faqOpen.trial}
        ...
        <footer className="pb-6 pt-12 text-xs text-white/45">
          ...
          <div className="mt-6 text-[11px] text-white/35">
            Starter is monthly-only. Top-up packs scale Creator credits + pricing only.
