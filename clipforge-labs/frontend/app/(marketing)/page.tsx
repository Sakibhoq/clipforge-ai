...
export default function Page() {
  ...
  const sampleClips = useMemo<SampleClip[]>(
    () => [
      {
        title: "Real clip",
        text: "Photoreal, vertical social framing with clean subject focus and motion.",
        duration: "7s",
        aspect: "9:16",
        style: "Real",
      ...
      {
        title: "Cartoon clip",
        text: "Stylized cartoon look in a wide cinematic composition for contrast.",
        duration: "7s",
        aspect: "16:9",
        style: "Cartoon",
      ...
      {
        title: "Anime clip",
        text: "Anime-style vertical composition with sharp silhouette and high contrast.",
        duration: "7s",
        aspect: "9:16",
        style: "Anime",
      ...
      {
        title: "Comic clip",
        text: "Comic-book vertical framing with bold edge detail and strong focal point.",
        duration: "7s",
        aspect: "9:16",
        style: "Comic",
