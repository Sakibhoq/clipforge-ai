  ...
  return (
    <div className="relative overflow-x-hidden [max-width:100vw]" style={rootStyle}>
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -top-[22vmin] left-[-18vmin] h-[54vmin] w-[54vmin] rounded-full bg-[radial-gradient(circle_at_center,rgba(255,183,3,0.20),transparent_62%)] blur-3xl" />
        <div className="absolute top-[10vmin] right-[-18vmin] h-[58vmin] w-[58vmin] rounded-full bg-[radial-gradient(circle_at_center,rgba(58,134,255,0.17),transparent_64%)] blur-3xl" />
        <div className="absolute bottom-[-24vmin] left-[6vmin] h-[64vmin] w-[64vmin] rounded-full bg-[radial-gradient(circle_at_center,rgba(251,86,7,0.13),transparent_65%)] blur-3xl" />
      ...
      <main className="relative mx-auto max-w-lg px-6 pb-14 pt-10 sm:pt-12">
        <section className="surface-soft relative w-full overflow-hidden p-6 md:p-8">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(180px 140px at 25% 30%, rgba(255,183,3,0.18), transparent 72%), radial-gradient(200px 160px at 80% 45%, rgba(58,134,255,0.16), transparent 72%), radial-gradient(200px 160px at 50% 88%, rgba(251,86,7,0.12), transparent 72%)",
            }}
          />
