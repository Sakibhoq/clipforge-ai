...
def build_s3_client(*, region_name: str | None = None):
    ...
    # GCS S3 compatibility is sensitive to payload-signing/checksum defaults in
    # newer botocore versions, especially for PutObject paths.
    if is_gcs_endpoint:
    ...
    try:
        ...
        # Backward compatibility for older botocore builds that do not support
        # checksum config kwargs.
